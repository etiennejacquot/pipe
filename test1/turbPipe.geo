...
th=PI/4.;  //theta
lambda=0.3;   //=R_{arc}/R
Lz=8;   //length in z-dir (axial)
//***** Grid Paramaters
Nc=6;  // no. of nodes (=#elem+1) in azimuthal direction
NB=2;   // no. of elemtns adjacent to the wall
NM=2;   // no. of nodes (=#elem+1) between the near wall layer and central square part
...
Nz=40;    //no of elements in z-dire (axial)
///////////////////////////////////////////////////
